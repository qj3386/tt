...
alter table fl_user_message AUTO_INCREMENT=100000;
truncate table fl_user_money;
alter table fl_user_money AUTO_INCREMENT=100000;
truncate table fl_user_point;
truncate table fl_user_project;
alter table fl_user_project AUTO_INCREMENT=100000;
truncate table fl_user_project_income;
alter table fl_user_project_income AUTO_INCREMENT=100000;
truncate table fl_user_recharge;
alter table fl_user_recharge_income AUTO_INCREMENT=100000;
truncate table fl_user_withdraw;
alter table fl_user_withdraw AUTO_INCREMENT=100000;
