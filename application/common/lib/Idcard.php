...
class Idcard
{
	 ...
	 * 获取省
	 */
    public function get_province_name ($idcard_number) {
    	$province = array(
	        11 => "北京",
	        12 => "天津",
	        13 => "河北",
    	...
    	//截取前两位数
    	$index = substr($idcard_number, 0, 2);
		if (isset($arr[$index])) {
			return $arr[$index];
		}
		return '';
	 ...
	 * 获取地址
	 */
	public function get_idcard_province_city_district ($idcard_number) {
		$arr = array(
			'110000' => '北京市',
			'110100' => '北京市市辖区',
			'110101' => '北京市东城区',
		...
		if (strlen($idcard_number) > 6) {
			$idcard_number = substr($idcard_number, 0, 6);
		}
		if (isset($arr[$idcard_number])) {
			return $arr[$idcard_number];
		}
		return '';
	}
}